...
export const workHistory = [
  {
    ...
    type: "Internship",
    highlights: [
      "Shipped AI-powered semantic search over Elasticsearch, embedding operator docs as vectors for real-time retrieval.",
      "Built SaaS operator dashboards in Vue (Nuxt, TypeScript), integrating Elasticsearch APIs with Vitest unit testing.",
      "Designed responsive UI components in Figma and built a reusable component library conforming to WCAG 2.1 AA.",
      "Architected Go REST API for web crawl orchestration with Elasticsearch indexing and Kibana Discover integration.",
      "Engineered a Go proxy service with custom middleware for multi-client data aggregation, filtering, and routing.",
      "Containerized and deployed services to AWS ECR with Docker and Kubernetes, instrumented with Elastic APM.",
    ],
    logo: ilsLogo,
  },
  {
    ...
    company: "George Mason University Legal Systems Policy Lab",
    location: "Fairfax, VA, USA",
    type: "Internship",
    highlights: [
      "Built full-stack pipeline in Node.js with Selenium, orchestrating the scraping and transformation of over 20,000 pieces of legislation.",
      "Integrated Google Vertex AI into backend services to auto-generate structured metadata, enabling AI-assisted research.",
      "Shipped full-stack features using TypeScript, React, Next.js, and Node.js and architected custom Chart.js visualizations.",
      "Ran user research with domain experts and translated findings into Figma prototypes and shipped UI features.",
    ],
    logo: gmuLogo,
    logoFill: true,
  },
  {
    ...
    type: "Undergraduate",
    highlights: [
      "Coursework in Algorithms, Software Engineering, Database Systems, Human-Centered Design, and Computer Systems.",
      "Focus on the intersection of technical depth and user-centered product thinking.",
    ],
    logo: gwuLogo,
    isEducation: true,
  },
